...
Assert-Contains $spider 'bmb_spider_climb_speed",\s*"82"' "Spider climb spike should expose the faster Phase 2 climb speed tuning."
...
Assert-Contains $spider 'bmb_spider_climb_mantle_speed",\s*"58"' "Spider climb should expose smooth mantle speed tuning."
...
Assert-Contains $spider 'bmb_spider_climb_descend_speed",\s*"78"' "Spider climb should expose descend speed after a blocked climb."
